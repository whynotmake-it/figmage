...
class Config with EquatableMixin {
  ...
  const Config({
    ...
    this.json = const JsonTokenSourceConfig(),
    this.dropUnresolved = false,
    this.includeDeletedButReferenced = false,
  ...
  /// Optional JSON token sources.
  final JsonTokenSourceConfig json;
  ...
  /// Whether to include variables that have been deleted but are still
  /// referenced.
  ///
...
/// {@template json_token_source_config}
/// Settings for JSON token sources.
/// {@endtemplate}
@JsonSerializable(anyMap: true, checked: true)
class JsonTokenSourceConfig with EquatableMixin {
  /// {@macro json_token_source_config}
  const JsonTokenSourceConfig({
    this.paths = const [],
  });

  /// Initializes a [JsonTokenSourceConfig] from a json map.
  ...
  Map<String, dynamic> toJson() => _$JsonTokenSourceConfigToJson(this);
