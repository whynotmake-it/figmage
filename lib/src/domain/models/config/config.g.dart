    ...
    $checkedCreate('Config', json, ($checkedConvert) {
      final val = Config(
        ...
        packageDescription: $checkedConvert(
          'packageDescription',
          (v) =>
              v as String? ?? 'A design tokens package, generated by figmage',
        ),
        json: $checkedConvert(
          'json',
          (v) => v == null
              ? const JsonTokenSourceConfig()
              : JsonTokenSourceConfig.fromJson(v as Map),
        ),
        dropUnresolved: $checkedConvert(
          'dropUnresolved',
          (v) => v as bool? ?? false,
        ),
        includeDeletedButReferenced: $checkedConvert(
          'includeDeletedButReferenced',
          (v) => v as bool? ?? false,
        ),
        stylesFromLibrary: $checkedConvert(
          'stylesFromLibrary',
          (v) => v as bool? ?? false,
        ),
...
Map<String, dynamic> _$ConfigToJson(Config instance) => <String, dynamic>{
  ...
  'includeDeletedButReferenced': instance.includeDeletedButReferenced,
...
GenerationSettings _$GenerationSettingsFromJson(Map json) =>
    $checkedCreate('GenerationSettings', json, ($checkedConvert) {
      final val = GenerationSettings(
        generate: $checkedConvert('generate', (v) => v as bool? ?? true),
        from: $checkedConvert(
          'from',
          (v) => (v as List<dynamic>?)?.map((e) => e as String) ?? const [],
        ),
        inheritance: $checkedConvert(
          'inheritance',
          (v) =>
              (v as List<dynamic>?)?.map(
                (e) => InheritanceSettings.fromJson(
...
JsonTokenSourceConfig _$JsonTokenSourceConfigFromJson(Map json) =>
    $checkedCreate('JsonTokenSourceConfig', json, ($checkedConvert) {
      final val = JsonTokenSourceConfig(
...
Map<String, dynamic> _$JsonTokenSourceConfigToJson(
  JsonTokenSourceConfig instance,
) => <String, dynamic>{'paths': instance.paths.toList()};

TypographyGenerationSettings _$TypographyGenerationSettingsFromJson(Map json) =>
    $checkedCreate('TypographyGenerationSettings', json, ($checkedConvert) {
...
InterfaceSettings _$InterfaceSettingsFromJson(Map json) =>
    $checkedCreate('InterfaceSettings', json, ($checkedConvert) {
...
Map<String, dynamic> _$InterfaceSettingsToJson(InterfaceSettings instance) =>
    <String, dynamic>{'name': instance.name, 'import': instance.import};

AssetNodeSettings _$AssetNodeSettingsFromJson(Map json) =>
    $checkedCreate('AssetNodeSettings', json, ($checkedConvert) {
      final val = AssetNodeSettings(
        name: $checkedConvert('name', (v) => v as String),
        scales: $checkedConvert(
          'scales',
          (v) =>
              (v as List<dynamic>?)?.map((e) => e as num).toSet() ?? const {1},
        ),
      );
      return val;
    });
...
AssetGenerationSettings _$AssetGenerationSettingsFromJson(Map json) =>
    $checkedCreate('AssetGenerationSettings', json, ($checkedConvert) {
