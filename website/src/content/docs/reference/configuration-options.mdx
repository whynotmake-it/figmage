...
It can be useful to set this to false, if you want to use Figmage to generate files in an existing package, so that it won't overwrite your existing pubspec.yaml file.
